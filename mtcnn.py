...
class MTCNN:
    ...
    def align(self, img):
        ...
        warped_face = warp_and_crop_face(
            np.array(img), facial5points, self.reference, crop_size=(112, 112)
        )
        return Image.fromarray(warped_face)

    def align_multi(
        self, img: Image.Image, limit: Optional[int] = None, min_face_size: float = 30.0
        ...
        for landmark in landmarks:
            ...
            warped_face = warp_and_crop_face(
                image_np, facial5points, self.reference, crop_size=(112, 112)
            )
